...
<main>
    ...
    <div id="prompt">
        A<?php print_r(array_random($medium)); ?><?php print_r(array_random($event)); ?> </strong>
    ...
    <div id="blurb">
        ...
        <p>For example, the well-known AO3 exchange <a href="https://fanlore.org/wiki/Yuletide">Yuletide</a> would have the following result:</p> 
        <blockquote>A fanfiction exchange centered around (an) underrated fandoms</blockquote></p>
